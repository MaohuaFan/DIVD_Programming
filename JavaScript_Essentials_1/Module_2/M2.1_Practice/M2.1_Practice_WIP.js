// Question 1: Write a code that will create variables and 
    ...
    let b1 = true; let b2 = Boolean(true); let n1 = 100; let n2 = Number(200); let bi1 = 100n; let bi2 = BigInt(200);
...
// Question 3: Carry out a chain of conversions: create a Boolean from a BigInt created 
    ...
    let b = Boolean( BigInt(Number("1234"))); console.log(`${b} [${typeof b}]`); // or let s = "1234"; let n =
    Number(s); let bi = BigInt(n); let b = Boolean(bi); console.log(`${b} [${typeof b}]`);
